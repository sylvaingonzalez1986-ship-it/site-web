      ...
      <div className={styles.content}>
        ...
        <div className={styles.columns} data-management-only={!showAccounting}>
          ...
          {showAccounting ? <section className={styles.accounts} aria-label="Charges et échéances">
            ...
            <div className={styles.lab}><h3><FlaskConical size={18} aria-hidden="true" /> Analyses laboratoire</h3><p>{formatKqCash(KQ_LAB_ANALYSIS_CENTS)} par tente et par culture terminée, à régler sous 30 jours de jeu (5 jours réels). À l’échéance, paiement automatique si les fonds suffisent.</p>
