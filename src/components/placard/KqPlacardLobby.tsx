...
const DESTINATIONS = [
  ...
  { id: "treasury", title: "Le bureau", action: "Ouvrir ma trésorerie", detail: "Comptabilité, banque et gestion : retrouve tes factures, ton plan comptable et les projets de ton entreprise.", image: "/placard/commerce-office-v2.webp", icon: Wallet },
