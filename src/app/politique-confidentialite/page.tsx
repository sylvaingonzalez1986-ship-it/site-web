...
const privacyUrl = `${siteUrl}/politique-confidentialite`;

export const metadata: Metadata = {
  title: "Politique de confidentialite",
  description:
    "Politique de confidentialite du site Les Chanvriers Bretons relative à la collecte et au traitement des données personnelles.",
  alternates: {
