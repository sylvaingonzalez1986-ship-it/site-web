...
## Correctif d’affichage sur PC

Le sprite est rendu par une véritable image HTML dans un cadre, avec déplacement
par étapes. Le délai minimal commence après son chargement et son décodage,
pas à l’envoi de la vente. Le test sur PC reproduit un téléchargement retardé
de 4,5 secondes et vérifie la présence de Sylvain avant le reçu. Un échec de
chargement affiche un pictogramme et laisse accéder au reçu ; l’attente est
plafonnée à dix secondes. Les animations réduites restent respectées.
