...
Carnet, Placard et Classement changent normalement le décor. Leur bouton d’entrée affiche « Rendez-vous le 15 octobre ». Les liens directs renvoient vers l’accueil avec le décor correspondant et la bulle ouverte. Le tutoriel de jeu est suspendu. Les API publiques d’activité renvoient 423 ; seules la visibilité du menu et la lecture/écriture du personnage sont disponibles. Les aperçus administrateur gardent leurs protections existantes. Le développement local conserve les outils de test habituels.
