...
const modules={
  'workshop-entry': `import React from 'react'; import {createRoot} from 'react-dom/client'; import '/src/app/globals.css'; import retro from '/src/components/contest/ArenaRetro.module.css';
    ...
    const snapshot={cashCents:25000,electricityOutstandingCents:1377,reputation:100,reputationRank:12,ownedCodes:equipmentCodes,equippedCodes:equipmentCodes,routePlan:null,routeMasteries:[],equipmentSummary:{processingPrecision:30,processingCapacityPercent:50},lots:params.has('empty')?[]:[lot]};
