...
async function main() {
  ...
  const tables = [
    { table: "kq_treasury_accounts", owner: "user_id", columns: ["user_id", "started_at"] },
    { table: "kq_treasury_journal", owner: "user_id",
      columns: ["id", "user_id", "source_key", "kind", "reference", "occurred_at", "recorded_at", "transaction_id", "postings"] },
    { table: "kq_treasury_balances", owner: "user_id", columns: ["user_id", "account", "balance_cents"] },
    { table: "kq_treasury_assets", owner: "user_id",
      columns: ["id", "user_id", "source_key", "account", "expense_account", "equipment_code", "cost_cents", "recognized_cents",
        "starts_at", "ends_at", "recognized_at", "retired_at"] },
    { table: "kq_treasury_pending", owner: "user_id", columns: ["user_id", "transaction_id"] },
  ];
  const rpcPaths = ["/rpc/rpc_kq_treasury_snapshot"];
