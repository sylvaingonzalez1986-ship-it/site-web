...
const cityFaqMap: Record<string, CityFaqItem[]> = {
  "cbd-rennes": [
    ...
    { question: "Quel délai de livraison CBD à Rennes ?", answer: "Les commandes passées avant 14h sont généralement expédiées le jour même. Comptez 24 à 48h pour une livraison en point relais ou à domicile à Rennes et en Ille-et-Vilaine." },
  ...
  "cbd-quimper": [
    ...
    { question: "Combien de temps pour recevoir du CBD à Quimper ?", answer: "Expédition rapide depuis la Bretagne. La plupart des commandes arrivent à Quimper et dans le Finistère sous 48h en point relais ou livraison à domicile." },
  ...
  "cbd-brest": [
    ...
    { question: "Livrez-vous rapidement à Brest ?", answer: "Oui. Les commandes sont expédiées depuis la Bretagne avec un délai moyen de 24 à 48h pour Brest et l'agglomération brestoise, en point relais ou à domicile." },
  ...
  "cbd-vannes": [
    ...
    { question: "Livraison CBD Vannes : quels sont les délais ?", answer: "Nous expédions depuis la Bretagne. Les commandes vers Vannes et le Morbihan arrivent généralement sous 24 à 48h, via Mondial Relay ou livraison à domicile." },
  ...
  "cbd-saint-malo": [
    ...
    { question: "Livrez-vous en été à Saint-Malo pendant la saison touristique ?", answer: "Nous livrons toute l'année à Saint-Malo et sur la côte nord bretonne. Les délais restent de 24 à 48h, même en période estivale, grâce à notre logistique locale." },
  ...
  "cbd-vitre": [
    { question: "Est-il possible de se faire livrer du CBD à Vitré ?", answer: "Oui. Nous livrons à Vitré et dans toute la Bretagne en 24 à 48h. Plusieurs points relais Mondial Relay sont disponibles à Vitré et dans les communes environnantes." },
  ...
  "cbd-redon": [
    { question: "Puis-je commander du CBD depuis Redon ?", answer: "Oui. Notre boutique en ligne livre à Redon et partout en France métropolitaine. Commandez vos fleurs, huiles ou résines CBD et recevez-les sous 24 à 48h." },
